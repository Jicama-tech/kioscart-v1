  ...
  if (!cart) {
    return (
      <div className="flex flex-col items-center justify-center h-full text-muted-foreground p-6">
        ...
        <p className="text-sm font-medium">{i18nT("No active cart")}</p>
        <p className="text-xs mt-1">{i18nT("Create a new cart or resume a parked one")}</p>
      </div>
    );
  }
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 overflow-y-auto space-y-2">
        {cart.items.length === 0 ? (
          <div className="text-center text-muted-foreground text-xs py-8">
            {i18nT("Add products from the left panel")}
          </div>
        ) : (
      ...
      <div className="border-t pt-3 mt-3 space-y-2">
        <div className="flex justify-between items-center">
          <span className="text-sm font-medium text-muted-foreground">{i18nT("Total")}</span>
